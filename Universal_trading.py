...
SELL = "BTC-26JAN24"#"BTC-27JAN23" # Put the orders in ask
#SELL = "BTC-PERPETUAL"#"BTC-PERPETUAL" #Put the orders in bid

BUY = "BTC-5JAN24"#"BTC-PERPETUAL" #Put the orders in bid
crypto = "BTC"


enterprice = 475#-30 nå håper vi å selge oss ut på 4600 ca
buyrange = 5
top_range = enterprice + buyrange
low_range = enterprice - buyrange

unload_qty = 3200 # the qty to sell before terminating the program
trade_qty = 400
...
def subscribeMarketData():
    ...
    message.append_pair(146, 2) # Number of symbols requested. Necessary if more than 1 Symbol requested
  
    message.append_pair(55, BUY)
    message.append_pair(55, SELL)
    inc +=1
...
s.sendall(subscribeMarketData().encode())
